...
class DashboardButtonRight: UIButton {
    ...
    func setupConstraints() {
        let iconTrailing = NSLayoutConstraint(item: self.iconImageView, attribute: .trailing, relatedBy: .equal, toItem: self, attribute: .trailing, multiplier: 1, constant: -12)
        ...
        self.addConstraints([iconTrailing, iconTop, iconHeight])

        let arrowTrailing = NSLayoutConstraint(item: self.arrowImageView, attribute: .trailing, relatedBy: .equal, toItem: self, attribute: .trailing, multiplier: 1, constant: -12)
        ...
        self.addConstraints([arrowTrailing, arrowBottom, arrowHeight, arrowWidth])
